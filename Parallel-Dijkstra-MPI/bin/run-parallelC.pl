...
# param setup:
$RESFILE   = "results/parallel.chk";
$PREFIX    = "../../inputs/";
$SOLVER    = "parallel/mpiC.out";
...
sub DORUN {
    ...
    $out = `mpiexec -np 2 $SOLVER $graphname $auxname $RESFILE`;
}

# run benchmark code
&DORUN("USA-road-d/USA-road-d.NY");
&DORUN("USA-road-d/USA-road-d.NE");
&DORUN("USA-road-d/USA-road-d.CTR");
&DORUN("USA-road-t/USA-road-t.NY")
&DORUN("USA-road-t/USA-road-t.NE")
&DORUN("USA-road-t/USA-road-t.CTR")
